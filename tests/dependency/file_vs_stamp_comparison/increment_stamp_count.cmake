# Increment stamp-based execution counter
if(NOT CMAKE_ARGC EQUAL 4)
    message(FATAL_ERROR "Usage: cmake -P increment_stamp_count.cmake <count_file>")
endif()
...
message(STATUS "Stamp-based build executed (count: ${new_count})")