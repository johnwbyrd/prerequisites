# Increment file-based execution counter
if(NOT CMAKE_ARGC EQUAL 4)
    message(FATAL_ERROR "Usage: cmake -P increment_file_count.cmake <count_file>")
endif()
...
message(STATUS "File-based build executed (count: ${new_count})")